...
```{r iframe}
htmltools::tags$iframe(title = "Krona chart", src = snakemake@input[["krona"]], width ="100%", height="800px") 
```
...
Needs rework with proper headings for all cases and usefull definitions.
