...
usage: FooDMe [-h] [-v] -l SAMPLE_LIST -d WORKING_DIRECTORY [--forceall] [-n]
              [-t THREADS] [--threads_sample THREADS_SAMPLE] [-c CONDAPREFIX]
              [-s SNAKEFILE] [--clean_temp] [--fastp_length FASTP_LENGTH]
              ...
              [--chim_denovo] [--chim_ref CHIM_REF] [--blastdb BLASTDB]
              [--taxdb TAXDB] [--e_val E_VAL] [--blast_id BLAST_ID]
