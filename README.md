...
* The pipeline will crash if no BLAST hits are found. 
...
The config file will be automatically generated in the working directory with default values. 
...
usage: foodme.py [-h] -l SAMPLE_LIST -d WORKING_DIRECTORY [--forceall] [-n]
                 ...
                 [-c CONDAPREFIX] [-s SNAKEFILE] [--clean_temp]
