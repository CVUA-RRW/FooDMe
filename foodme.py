...
def main(): 
    ...
    parser.add_argument('-v', '--version', action='version', version="FooDMe version: "+ version, help="Print pipeline version and exit")
    ...
    smkargs.add_argument('-s', '--snakefile', required=False, type=os.path.abspath, default=os.path.join(sys.path[0], "workflow", "Snakefile"),
                        help="Path to the Snakefile in the FoodMe repo")
